...
def worker_process_main(
    ...
    try:
        ...
        while completed_episodes < assigned_episodes:
            ...
            completed_total = initial_completed + completed_episodes
            status_dict[worker_id] = {
                "pid": os.getpid(),
            ...
            if completed_episodes % sync_interval == 0 or completed_episodes == assigned_episodes:
